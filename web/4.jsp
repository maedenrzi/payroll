        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="item active">
                    <img src="resources/images/2.jpeg" style="height: 400px ; width:750px" alt="..." onclick="window.location.href='Students.html';">
                </div>
                <h2 class="featurette-heading">Let's learn. <span class="text-muted">Let's Meco.</span></h2>
                <p class="card-text">Visit the Robotic Class, Istanbul Fajr School , Turkey you can see more pictures and videos bottom. Visit the Robotic Class, Istanbul Fajr School.Visit the Robotic Class, Istanbul Fajr School ,
                    Turkey you can see more pictures and videos bottom. Visit the Robotic Class, Istanbul Fajr School. </p>
                <br>
                <br>
            </div>
        </div>
