    ...
    <main>
        ...
        <table class="table table-striped" border="1" width="100%">
            <tr>
                ...
                <th style="display:none">basic_salary</th>
                <th style="display:none">loan</th>
                <th style="display:none">over_time</th>
                <th style="display:none">insurance_money</th>
                <th style="display:none">toll</th>
                <th style="display:none">roleId</th>
                <th style="display:none">req</th>
                <th style="display:none">main_salary</th>
                <th>update</th>
                <th>delete</th>
            </tr>
            <%
                String month = (String) request.getAttribute("month");
                List<Person> personList = (List<Person>) request.getAttribute("select_profile");
            ...
            <tr>
                ...
                <form class="" action="/person/update_profile.do">
                    ...
                    <td><input type="text" style=" width: 100%" name="name" value="<%=person.getName()%>"/></td>
                    <td><input type="text" style=" width: 100%" name="family" value="<%=person.getFamily()%>"/></td>
                    <td><input type="text" style="width: 100%" name="Email" value="<%=person.getEmail()%>"/></td>
                    <td><input type="text" style="width: 100%" name="phone_number" value="<%=person.getPhone_number()%>"/></td>
                    <td><input type="text" style="width: 100%" name="national_id" value="<%=person.getNational_id()%>"/></td>
                    ...
                    <td style="display:none"><input type="text" style="width: 100%" name="bonus" value="<%=salary.getBonus()%>"/></td>
                    <td style="display:none"><input type="text" style="width: 100%" name="basic_salary" value="<%=salary.getBasic_salary()%>"/></td>
                    <td style="display:none"><input type="text" style="width: 100%" name="Loan" value="<%=salary.getLoan()%>"/></td>
                    ...
                    <td style="display:none"><input type="text" style="width: 100%" name="over_time" value="<%=over_time%>"/></td>
                    <td style="display:none"><input type="text" style="width: 100%" readonly name="insurance_money" value="<%=ins%>"/></td>
                    <td style="display:none"><input type="text" style="width: 100%" readonly name="toll" value="<%=toll%>"/></td>
                    ...
                    <td style="display:none"><input type="text" style="width: 100%" readonly name="main_salary" value="<%=salary.getBasic_salary()+salary.getBonus()+salary.getOver_time()-salary.getLoan()-ins-toll%>"/></td>
                    <td><input type="submit" style=" width: 100%" value=" update "/></td>
                </form>
                <td><input type="button" style=" width: 100%" value=" delete" onclick="window.location='/person/remove_profile.do?id=<%=person.getId()%>'"></td>
            </tr>
            <%
                }
            %>
