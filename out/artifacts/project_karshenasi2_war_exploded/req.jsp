...
<body>
 <div class="container">
                ...
                <div id="menu">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="/month_users.jsp"><b>&nbsp;&nbsp;All_Users</b></a></li>
   ...
   <%
       List<Person> personList = (List<Person>) request.getAttribute("selectReq");
       for (Person person : personList) {
           Salary salary=person.getSalary();
   %>

                <tr>
                    <form class="" action="/person/accept.do">
                        ...
                        <td style="display:none"><input type="text"  style="width: 100%" readonly name="accId" value="<%=person.getAccId()%>"/></td>
                        <td><input type="submit" style=" width: 100%" value=" accept "/></td>
                    </form>
                    <form class="" action="/person/reject.do">
                        <td style="display:none"><input type="text" style=" width: 100%" readonly name="id" value="<%=person.getId()%>"/></td>
                        <td style="display:none"><input type="text" style=" width: 100%" name="name" value="<%=person.getName()%>"/></td>
                        <td style="display:none"><input type="text" style=" width: 100%" name="family" value="<%=person.getFamily()%>"/></td>
                        <td style="display:none"><input type="text" style="width: 100%" name="Email" value="<%=person.getEmail()%>"/></td>
                        <td style="display:none"><input type="text" style="width: 100%" name="phone_number" value="<%=person.getPhone_number()%>"/></td>
                        <td style="display:none"><input type="text" style="width: 100%" readonly name="personal_number" value="<%=person.getPersonal_number()%>"/></td>
                        <td style="display:none"><input type="text" style="width: 100%" name="national_id" value="<%=person.getNational_id()%>"/></td>
                        <td style="display:none"><input type="text" readonly style="width: 100%" name="month" value="<%=person.getMonth()%>"/></td>
                        <td style="display:none"><input type="text" style="width: 100%" name="bonus" value="<%=salary.getBonus()%>"/></td>
                        <td style="display:none"><input type="text" style="width: 100%" name="basic_salary" value="<%=salary.getBasic_salary()%>"/></td>
                        ...
                        <td style="display:none"><input type="text" style="width: 100%" readonly name="main_salary" value="<%=salary.getBasic_salary()+salary.getBonus()+salary.getOver_time()-salary.getLoan()-ins-toll%>"/></td>
                        <td style="display:none"><input type="text"  style="width: 100%" readonly name="accId" value="<%=person.getAccId()%>"/></td>
                        <td><input type="submit" style=" width: 100%" value=" reject "/></td>
                    </form>
                   <%-- </form>
                    <form class="" action="/person/reject.do">
                        <td style="display:none"><input type="text" readonly style="width: 100%" name="month" value="<%=person.getMonth()%>"/></td>
                    <td><input type="submit" style=" width: 100%" value=" reject" onclick="window.location='/person/reject.do'"></td>
                    </form>--%>
                </tr>
                <%
                    }
