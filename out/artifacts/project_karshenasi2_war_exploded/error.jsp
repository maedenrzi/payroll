<%@ page import="net.sf.oval.ConstraintViolation" %>
...
<div class="container">
    ...
    <main>
        <table class="table table-striped" border="1" width="100%">
            ...
            <%
                List<ConstraintViolation > allError= (List<ConstraintViolation>) request.getAttribute("error");
                for (ConstraintViolation constraintViolation : allError) {
                    out.println(constraintViolation.getErrorCode());

            %>
        <tr>


                <td><input type="text" style=" width: 100%" readonly name="error" value="<%=constraintViolation.getErrorCode()%>"/></td>
        </tr>
            <%
                }
            %>
