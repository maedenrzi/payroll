        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="item active">
                    <img src="resources/images/1.jpeg" style="height: 400px ; width:750px" alt="..." onclick="window.location.href='Students.html';">
                </div>
                ...
                <p class="card-text">The final robotic tournament in Iranian schools in Muscat , Oman
                    you can see more pictures and videos bottom.The final robotic .The final robotic tournament in Iranian schools in Muscat , Oman
